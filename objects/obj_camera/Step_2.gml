...
if (instance_exists(obj_player) && instance_exists(global.camera_zone) && !global.isWarp)
{
...
else if (instance_exists(obj_player) && instance_exists(global.camera_zone) && global.isWarp)
{
	var _x = clamp(obj_player.x - (view_width / 2),
	max(0, global.camera_zone.bbox_left),
	min(room_width, global.camera_zone.bbox_right) - view_width);
